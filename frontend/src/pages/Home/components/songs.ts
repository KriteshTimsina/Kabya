...
export const songs:ISong[] = [
    {
        ...
        track:"Rail Garee",
        image:"https://upload.wikimedia.org/wikipedia/en/d/d0/Sketchesofdajeelingcover.jpg",
        lyrics:{
            NEP:`
