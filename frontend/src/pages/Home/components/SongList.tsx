...
const SongList = ({ song }: { song: ISong }) => {
  ...
  return (
    <div
      ...
      className="px-1 flex gap-10 md:gap-32 py-2 items-center w-full md:w-3/4  justify-start border-b-secondary border-b-[1px] pb-1 hover:bg-secondary cursor-pointer "
    >
